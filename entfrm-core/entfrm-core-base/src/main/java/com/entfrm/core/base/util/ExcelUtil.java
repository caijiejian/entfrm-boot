...
import com.entfrm.core.base.annotation.Excel.ColumnType;
import com.entfrm.core.base.annotation.Excel.Type;
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (val instanceof String) {
                            val = com.entfrm.core.base.util.DateUtil.parseDate(val);
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StrUtil.isNotEmpty(dateFormat) && !StrUtil.isEmptyIfStr(value)) {
                    cell.setCellValue(com.entfrm.core.base.util.DateUtil.parseDateToStr(dateFormat, (Date) value));
